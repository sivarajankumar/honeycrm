...
public class ServiceTest extends AbstractClientTest {
	...
	public void testSearch() {
		...
		commonService.search(IANA.mashal(DtoAccount.class), contact, 0, 0, new AsyncCallback<ListQueryResult<? extends Viewable>>() {
			@Override
			public void onFailure(Throwable caught) {
				fail();
			}
			...
			public void onSuccess(ListQueryResult<? extends Viewable> result) {
				...
				for (final Viewable item: result.getResults()) {
