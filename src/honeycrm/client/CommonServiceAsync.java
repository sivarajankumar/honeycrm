...
public interface CommonServiceAsync {
	void getAll(final String dtoIndex, int from, int to, AsyncCallback<ListQueryResult<Dto>> callback);
	void get(String dtoIndex, long id, AsyncCallback<Dto> callback);
	void search(String dtoIndex, Dto searchContact, int from, int to, AsyncCallback<ListQueryResult<Dto>> callback);
	...
	void getAllByNamePrefix(String dtoIndex, String prefix, int from, int to, AsyncCallback<ListQueryResult<Dto>> callback);
	void getByName(String dtoIndex, String name, AsyncCallback<Dto> callback);
	void fulltextSearch(String query, int from, int to, AsyncCallback<ListQueryResult<Dto>> callback);
	void mark(String dtoIndex, long id, boolean marked, AsyncCallback<Void> callback);
	void getAllMarked(String dtoIndex, int from, int to, AsyncCallback<ListQueryResult<Dto>> callback);
	...
	void getAllRelated(String originatingDtoIndex, Long id, String relatedDtoIndex, AsyncCallback<ListQueryResult<Dto>> callback);
	void fulltextSearchForModule(String dtoIndex, String query, int from, int to, AsyncCallback<ListQueryResult<Dto>> callback);
