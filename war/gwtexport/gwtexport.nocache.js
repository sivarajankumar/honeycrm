function gwtexport(){
  ...
  gwtexport.onScriptLoad = function(){
    if (frameInjected) {
      loadDone = true;
      maybeStartModule();
    }
  ...
  ;
  gwtexport.onInjectionDone = function(){
    scriptsDone = true;
