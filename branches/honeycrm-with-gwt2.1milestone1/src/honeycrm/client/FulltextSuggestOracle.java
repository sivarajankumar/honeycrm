...
/*		suggestions.add(new MultiWordSuggestion("a", "a"));
		suggestions.add(new MultiWordSuggestion("aa", "aa"));
		suggestions.add(new MultiWordSuggestion("aaa", "aaa"));
		suggestions.add(new MultiWordSuggestion("b", "b"));
*/
